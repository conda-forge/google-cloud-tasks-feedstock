About google-cloud-tasks-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-tasks-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-tasks-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-tasks
# for installing globally
pixi global install google-cloud-tasks
```
...
It is possible to list all of the versions of `google-cloud-tasks` available on your platform:
...
```
pixi search google-cloud-tasks --channel conda-forge
```
